...
import co.edu.uniandes.mktecoturism.entities.Compra;
...
import co.edu.uniandes.mktecoturism.facade.CompraFacade;
...
public class CompraController implements Serializable {
    ...
    @EJB
    private co.edu.uniandes.mktecoturism.facade.CompraFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("CompraCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("CompraUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("CompraDeleted"));
        if (!JsfUtil.isValidationFailed()) {
