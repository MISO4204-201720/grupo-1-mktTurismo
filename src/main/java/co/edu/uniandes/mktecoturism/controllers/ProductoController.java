...
import co.edu.uniandes.mktecoturism.facade.ProductoFacade;
...
public class ProductoController implements Serializable {
    ...
    @EJB
    private co.edu.uniandes.mktecoturism.facade.ProductoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("ProductoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("ProductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("ProductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
