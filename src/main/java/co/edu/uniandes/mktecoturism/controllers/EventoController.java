...
import co.edu.uniandes.mktecoturism.facade.EventoFacade;
...
public class EventoController implements Serializable {
    ...
    @EJB
    private co.edu.uniandes.mktecoturism.facade.EventoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("EventoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("EventoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/co/edu/uniandes/mktecoturism/util/Bundle").getString("EventoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
